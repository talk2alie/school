...
public class EmployeeRecord {
	...
	public static double getRate(EmployeeRecord record) {
		return record.getRate();
	}
	
	public static void updateHoursWroked(EmployeeRecord record, int newHoursWorked) {
		record.updateHoursWroked(newHoursWorked);
	}
}